...
const MOD_CATALOG = [
  ...
  { id: 'big_turbo',  name: 'Full Turbo Upgrade',         category: 'Forced Induction', stage: 3, cost: 300000, gainBadge: { text: 'Massive Gains (Tuned)', type: 'power' }, compatible: ['bmw-m340i','skoda-octavia-vrs','mercedes-amg-c43','porsche-911','audi-rs5'], note: 'Pure800/IS38/IS470 etc. Stage 3 territory. Needs built engine.' },
